...
import com.example.staffmanagementsystem.repository.ThongKeBaoCaoChamCong.TiLeDungGioRepository;
...
public class TiLeDungGioServiceImpl implements TiLeDungGioService {

    private final TiLeDungGioRepository repository;

    @Override
    public TiLeDungGioDTO tinhTiLeDungGio(LocalDate ngayChon, String loai, Integer maPhongBan, Integer maViTri) {
        ...
        return repository.tinhTiLeDungGio(tuNgay, denNgay, maPhongBan, maViTri);
    }
}
