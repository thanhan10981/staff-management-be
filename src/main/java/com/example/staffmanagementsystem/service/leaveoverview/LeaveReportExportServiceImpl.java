...
import com.example.staffmanagementsystem.utils.ExcelExportUtil;
...
public class LeaveReportExportServiceImpl implements LeaveReportExportService {
    ...
    @Override
    public byte[] exportLeaveReport(LeaveExportRequest request) {
        ...
        return ExcelExportUtil.exportLeaveReport(sheet1Raw, sheet2Raw);
    }
}
